...
export async function ChampionInfo({ championName }: Props) {
  ...
  try {
    ...
    return (
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform text-white">
        <p>There are no recent stats about {championName}. Play more !</p>
      </div>
    );
  }
}
